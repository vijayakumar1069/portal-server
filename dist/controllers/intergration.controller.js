...
export const freshdeskIntegrationSaveController = async (req, res) => {
    try {
...
export const hubspotIntegrationSaveController = async (req, res) => {
    try {
        const userId = req.user?.userId;
...
export const integrationStatusController = async (req, res) => {
    try {
        const userId = req.user?.userId;
        const user = await User.findById(userId);
        if (!user) {
